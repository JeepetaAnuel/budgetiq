...
const accents = {
  ...
  success: { ring: 'from-success/20 to-brand-600/20', icon: 'bg-success/10 text-success border-success/20' },
  danger: { ring: 'from-danger/20 to-brand-600/20', icon: 'bg-danger/10 text-danger border-danger/20' },
}
...
export default function StatCard({ title, value, icon, trend, accent = 'brand' }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-surface-light border border-border rounded-2xl p-5 hover:border-brand-500/30 transition-colors">
